module KebnekaiseMovingBlockEntity
using ..Ahorn, Maple

@pardef MovingBlockEntity(
    x1::Integer,
    y1::Integer,
    width::Integer=8,
    height::Integer=8,
...
Ahorn.editingOptions(entity::MovingBlockEntity) = Dict{String, Any}(
    "ease" => String[
        "Linear",
        "SineIn",
        "SineOut",
...
Ahorn.resizable(entity::MovingBlockEntity) = true, true
Ahorn.minimumSize(entity::MovingBlockEntity) = 8, 8
Ahorn.nodeLimits(entity::MovingBlockEntity) = 1, 1

function Ahorn.selection(entity::MovingBlockEntity)
...
function Ahorn.renderAbs(ctx::Ahorn.Cairo.CairoContext, entity::MovingBlockEntity, room::Maple.Room)
    tiletype = get(entity.data, "tiletype", "3")[1]
    Ahorn.drawTileEntity(ctx, room, entity, material = tiletype, blendIn = false)
end

function Ahorn.renderSelectedAbs(ctx::Ahorn.Cairo.CairoContext, entity::MovingBlockEntity, room::Maple.Room)
    x, y = Ahorn.position(entity)
